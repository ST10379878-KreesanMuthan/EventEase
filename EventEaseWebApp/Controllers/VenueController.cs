...
namespace EventEaseWebApp.Controllers
{
    ...
    public class VenueController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VenueId,VenueName,Capacity,ImageUrl")] Venue venue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenueId,VenueName,Capacity,ImageUrl")] Venue venue)
        {
            if (id != venue.VenueId)
            {
                return NotFound();
