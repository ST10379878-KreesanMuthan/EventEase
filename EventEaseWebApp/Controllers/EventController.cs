...
namespace EventEaseWebApp.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventId,VenueId,EventName,EventDate,Description")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,VenueId,EventName,EventDate,Description")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
